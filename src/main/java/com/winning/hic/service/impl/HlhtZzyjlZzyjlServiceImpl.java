...
public class HlhtZzyjlZzyjlServiceImpl implements  HlhtZzyjlZzyjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZzyjlZzyjl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count,real_count,Integer.parseInt(Constants.WN_ZZYJL_ZZYJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
