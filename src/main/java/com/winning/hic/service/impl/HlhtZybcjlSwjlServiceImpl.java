...
public class HlhtZybcjlSwjlServiceImpl implements HlhtZybcjlSwjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZybcjlSwjl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZYBCJL_SWJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
