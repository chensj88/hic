...
public class HlhtZybcjlHzjlServiceImpl implements  HlhtZybcjlHzjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZybcjlHzjl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count,real_count,Integer.parseInt(Constants.WN_ZYBCJL_HZJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
