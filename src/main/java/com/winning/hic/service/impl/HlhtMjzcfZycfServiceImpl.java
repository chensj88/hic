...
public class HlhtMjzcfZycfServiceImpl implements HlhtMjzcfZycfService {
    ...
    public List<MbzDataCheck> interfaceHlhtMjzcfZycf(MbzDataCheck entity) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count,real_count,Integer.parseInt(Constants.WN_MJZCF_ZYCF_SOURCE_TYPE),entity.getMap().get("startDate")+" 至 "+entity.getMap().get("endDate"));
