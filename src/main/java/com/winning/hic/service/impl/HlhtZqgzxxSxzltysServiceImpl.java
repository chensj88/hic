...
public class HlhtZqgzxxSxzltysServiceImpl implements HlhtZqgzxxSxzltysService {
    ...
    public List<MbzDataCheck> interfaceHlhtZqgzxxSxzltys(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZQGZXX_SXZLTYS_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
