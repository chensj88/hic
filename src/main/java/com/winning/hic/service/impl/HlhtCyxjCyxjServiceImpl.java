...
public class HlhtCyxjCyxjServiceImpl implements  HlhtCyxjCyxjService {
    ...
    public List<MbzDataCheck> interfaceHlhtCyxjCyxj(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count,real_count,Integer.parseInt(Constants.WN_CYXJ_CYXJ_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"),(String)t.getMap().get("isFlag"));
