...
public class HlhtZlczjlSxjlServiceImpl implements HlhtZlczjlSxjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZlczjlSxjl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZLCZJL_SXJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
