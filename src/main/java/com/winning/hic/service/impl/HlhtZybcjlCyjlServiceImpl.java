...
public class HlhtZybcjlCyjlServiceImpl implements HlhtZybcjlCyjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZybcjlCyjl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZYBCJL_CYJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"));
