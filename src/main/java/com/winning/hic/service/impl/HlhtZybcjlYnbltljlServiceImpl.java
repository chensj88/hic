...
public class HlhtZybcjlYnbltljlServiceImpl implements HlhtZybcjlYnbltljlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZybcjlYnbltljl(MbzDataCheck t) {
        ...
        for (MbzDataListSet dataListSet : dataListSets) {
            ...
            //2.根据模板代码去找到对应的病人病历
            List<HlhtZybcjlYnbltljl> hlhtZybcjlYnbltljlListFromBaseData = this.commonQueryDao.getHlhtZybcjlYnbltljlListFromBaseData(qtbljlk);
                ...
                for (HlhtZybcjlYnbltljl hlhtZybcjlYnbltljl : hlhtZybcjlYnbltljlListFromBaseData) {
                    ...
                    try {
                        ...
                        mbzLoadDataInfoDao.insertMbzLoadDataInfo(new MbzLoadDataInfo(
                                ...
                                hlhtZybcjlYnbltljl.getPatid(),hlhtZybcjlYnbltljl.getZyh(),hlhtZybcjlYnbltljl.getHzxm(),hlhtZybcjlYnbltljl.getXbmc(),hlhtZybcjlYnbltljl.getXbdm(),
                                hlhtZybcjlYnbltljl.getKsmc(), hlhtZybcjlYnbltljl.getKsdm(),   hlhtZybcjlYnbltljl.getBqmc(),hlhtZybcjlYnbltljl.getBqdm(), hlhtZybcjlYnbltljl.getSfzhm()));
