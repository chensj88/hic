...
public class HlhtZybcjlZkjlServiceImpl implements  HlhtZybcjlZkjlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZybcjlZkjl(MbzDataCheck t) {
        ...
        try{
            ...
            this.mbzDataCheckService.createMbzDataCheckNum(hlhtZybcjlZkjls.size(),real_count,Integer.parseInt(Constants.WN_ZYBCJL_ZKJL_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"),(String)t.getMap().get("isFlag"));
