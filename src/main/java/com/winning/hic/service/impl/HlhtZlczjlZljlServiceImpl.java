...
public class HlhtZlczjlZljlServiceImpl implements HlhtZlczjlZljlService {
    ...
    public List<MbzDataCheck> interfaceHlhtZlczjlZljl(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZLCZJL_ZLJL_SOURCE_TYPE), t.getMap().get("startDate") + " 至 " + t.getMap().get("endDate"),(String)t.getMap().get("isFlag"));
