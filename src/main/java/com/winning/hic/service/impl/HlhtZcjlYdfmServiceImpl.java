...
public class HlhtZcjlYdfmServiceImpl implements HlhtZcjlYdfmService {
    ...
    public List<MbzDataCheck> interfaceHlhtZcjlYdfm(MbzDataCheck t) {
        ...
        this.mbzDataCheckService.createMbzDataCheckNum(emr_count, real_count, Integer.parseInt(Constants.WN_ZCJL_YDFM_SOURCE_TYPE),t.getMap().get("startDate")+" 至 "+t.getMap().get("endDate"),(String)t.getMap().get("isFlag"));
