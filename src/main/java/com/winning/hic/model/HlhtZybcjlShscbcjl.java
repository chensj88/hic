 ...
 */
@Alias("hlhtZybcjlShscbcjl")
public class HlhtZybcjlShscbcjl extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setJzkssj(Date jzkssj){
        this.jzkssj = jzkssj;
   }
   /**
   * 字段名：jzjssj
