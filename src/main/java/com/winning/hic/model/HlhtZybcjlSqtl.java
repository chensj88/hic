 ...
 */
@Alias("hlhtZybcjlSqtl")
public class HlhtZybcjlSqtl extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setSsbwmc(String ssbwmc){
        this.ssbwmc = ssbwmc;
   }
   /**
   * 字段名：ssczrq
   ...
   * 备注: 
   */
   public void setSsyd(String ssyd){
        this.ssyd = ssyd;
   }
   /**
   * 字段名：sqzb
   ...
   * 备注: 
   */
   public void setMzsqm(String mzsqm){
        this.mzsqm = mzsqm;
   }
   /**
   * 字段名：ysbm
