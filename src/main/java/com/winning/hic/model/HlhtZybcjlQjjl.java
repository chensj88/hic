 ...
 */
@Alias("hlhtZybcjlQjjl")
public class HlhtZybcjlQjjl extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private String ssczbwdm;
    /**
     * 字段名：ssczbwmc
     * 备注: 
     * 默认值：无
     */
    private String ssczbwmc;
    /**
     * 字段名：jrwdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String jcjyxmmc;
    /**
     * 字段名：jcjyjg
     * 备注: 
     * 默认值：无
     */
    private String jcjyjg;
    /**
     * 字段名：jcjydljg
     * 备注: 
     * 默认值：无
     */
    private BigDecimal jcjydljg;
    /**
     * 字段名：jcjyjgdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String zyzwlbdm;
    /**
     * 字段名：zyzwlbmc
     * 备注: 
     * 默认值：无
     */
    private String zyzwlbmc;
    /**
     * 字段名：ysbm
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public void setBqbhqk(String bqbhqk){
        this.bqbhqk = bqbhqk;
   }
   /**
   * 字段名：qjcs
   ...
   * 备注: 
   */
   public void setSsczbwdm(String ssczbwdm){
        this.ssczbwdm = ssczbwdm;
   }
   /**
   * 字段名：ssczbwmc
   * get方法
   ...
   * 备注: 
   */
   public void setSsczbwmc(String ssczbwmc){
        this.ssczbwmc = ssczbwmc;
   }
   /**
   * 字段名：jrwdm
   * get方法
   ...
   * 备注: 
   */
   public void setCzcs(Short czcs){
        this.czcs = czcs;
   }
   /**
   * 字段名：qjksrq
   ...
   * 备注: 
   */
   public void setJcjyxmmc(String jcjyxmmc){
        this.jcjyxmmc = jcjyxmmc;
   }
   /**
   * 字段名：jcjyjg
   * get方法
   ...
   * 备注: 
   */
   public void setJcjyjg(String jcjyjg){
        this.jcjyjg = jcjyjg;
   }
   /**
   * 字段名：jcjydljg
   ...
   * 备注: 
   */
   public void setJcjydljg(BigDecimal jcjydljg){
   ...
   * 备注: 
   */
   public void setCjtlrymd(String cjtlrymd){
        this.cjtlrymd = cjtlrymd;
   }
   /**
   * 字段名：cjqjrydm
   * get方法
   ...
   * 备注: 
   */
   public void setZyzwlbdm(String zyzwlbdm){
        this.zyzwlbdm = zyzwlbdm;
   }
   /**
   * 字段名：zyzwlbmc
   * get方法
   ...
   * 备注: 
   */
   public void setZyzwlbmc(String zyzwlbmc){
        this.zyzwlbmc = zyzwlbmc;
   }
   /**
   * 字段名：ysbm
   * get方法
