 ...
 */
@Alias("hlhtRyjlRcyjl")
public class HlhtRyjlRcyjl extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private String yzklysbm;
    /**
     * 字段名：cyyzklrqm
     * 备注: 
     * 默认值：无
     */
    private String cyyzklrqm;
    /**
     * 字段名：cyyzklrq
     * 备注: 
     * 默认值：无
     */
    private Date cyyzklrq;
    /**
     * 字段名：jzysbm
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public void setRzzybmmc(String rzzybmmc){
        this.rzzybmmc = rzzybmmc;
   }
   /**
   * 字段名：rzzybmdm
   * get方法
   ...
   * 备注: 
   */
   public void setRzzyzhmc(String rzzyzhmc){
        this.rzzyzhmc = rzzyzhmc;
   }
   /**
   * 字段名：rzzyzhdm
   * get方法
   ...
   * 备注: 
   */
   public void setYzklysbm(String yzklysbm){
        this.yzklysbm = yzklysbm;
   }
   /**
   * 字段名：cyyzklrqm
   * get方法
   ...
   * 备注: 
   */
   public void setCyyzklrqm(String cyyzklrqm){
        this.cyyzklrqm = cyyzklrqm;
   }
   /**
   * 字段名：cyyzklrq
   * get方法
   ...
   * 备注: 
   */
   public void setCyyzklrq(Date cyyzklrq){
        this.cyyzklrq = cyyzklrq;
   }
   /**
   * 字段名：jzysbm
   * get方法
