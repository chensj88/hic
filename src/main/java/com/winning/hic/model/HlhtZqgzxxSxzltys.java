...
public class HlhtZqgzxxSxzltys extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setSxsdm(String sxsdm){
        this.sxsdm = sxsdm;
   }
   /**
   * 字段名：sxsmc
   ...
   * 备注: 
   */
   public void setSxqjcjg(String sxqjcjg){
        this.sxqjcjg = sxqjcjg;
   }
   /**
   * 字段名：sxfs
   * get方法
   ...
   * 备注: 
   */
   public void setSxblhg(String sxblhg){
        this.sxblhg = sxblhg;
   }
   /**
   * 字段名：yljgyj
