 ...
 */
@Alias("hlhtZybcjlSqxj")
public class HlhtZybcjlSqxj extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setSssyz(String sssyz){
        this.sssyz = sssyz;
   }
   /**
   * 字段名：ssjjz
