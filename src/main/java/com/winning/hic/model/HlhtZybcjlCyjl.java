 ...
 */
@Alias("hlhtZybcjlCyjl")
public class HlhtZybcjlCyjl extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setZyszjcjg(String zyszjcjg){
        this.zyszjcjg = zyszjcjg;
   }
   /**
   * 字段名：zfbm
   * get方法
