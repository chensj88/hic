 ...
 */
@Alias("hlhtMjzblJzlgbl")
public class HlhtMjzblJzlgbl extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private java.sql.Timestamp jzrqsj;
    /**
     * 字段名：czbzdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp srgcsrq;
    /**
     * 字段名：zs
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp yzklrq;
    /**
     * 字段名：yzshzdm
     * 备注: 
     * 默认值：无
     */
    private String yzshzdm;
    /**
     * 字段名：yzshzqm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp yzshrq;
    /**
     * 字段名：yzzxksdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp yzzxrq;
    /**
     * 字段名：yzzxzt
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp yzqxrq;
    /**
     * 字段名：zrysbm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private java.sql.Timestamp yzjhjsrq;
    /**
     * 字段名：dzsqdbh
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String jzlgbcjl;
    /**
     * 字段名：qjksrq
     * 备注: 
     * 默认值：无
     */
    private java.sql.Timestamp qjksrq;
    /**
     * 字段名：qjjsrq
     * 备注: 
     * 默认值：无
     */
    private java.sql.Timestamp qjjsrq;
    /**
     * 字段名：jzqjjl
     * 备注: 
     * 默认值：无
     */
    private String jzqjjl;
    /**
     * 字段名：ssjczbm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String ssmbbwbm;
    /**
     * 字段名：ssmbbw
     * 备注: 
     * 默认值：无
     */
    private String ssmbbw;
    /**
     * 字段名：jrwdm
     * 备注: 
     * 默认值：无
     */
    private String jrwdm;
    /**
     * 字段名：jrwmc
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String ssjczcs;
    /**
     * 字段名：jlrqsj
     * 备注: 
     * 默认值：无
     */
    private java.sql.Timestamp jlrqsj;
    /**
     * 字段名：zysx
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String cjqjrydm;
    /**
     * 字段名：cjqjrymd
     * 备注: 
     * 默认值：无
     */
    private String cjqjrymd;
    /**
     * 字段名：zyjszwlb
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String zyjszwlbmc;
    /**
     * 字段名：hzqxdm
     * 备注: 
     * 默认值：无
     */
    private String hzqxdm;
    /**
     * 字段名：hzqxmc
     * 备注: 
     * 默认值：无
     */
    private String hzqxmc;
    /**
     * 字段名：ysbm
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public java.sql.Timestamp getJzrqsj(){
   ...
   * 备注: 
   */
   public void setJzrqsj(java.sql.Timestamp jzrqsj){
        this.jzrqsj = jzrqsj;
   }
   /**
   * 字段名：czbzdm
   ...
   * 备注: 
   */
   public void setCzbzmc(String czbzmc){
        this.czbzmc = czbzmc;
   }
   /**
   * 字段名：srgcsrq
   ...
   * 备注: 
   */
   public java.sql.Timestamp getSrgcsrq(){
   ...
   * 备注: 
   */
   public void setSrgcsrq(java.sql.Timestamp srgcsrq){
        this.srgcsrq = srgcsrq;
   }
   /**
   * 字段名：zs
   * get方法
   ...
   * 备注: 
   */
   public void setXyzdbm(String xyzdbm){
        this.xyzdbm = xyzdbm;
   }
   /**
   * 字段名：xyzdmc
   ...
   * 备注: 
   */
   public void setXyzdmc(String xyzdmc){
        this.xyzdmc = xyzdmc;
   }
   /**
   * 字段名：zybmdm
   ...
   * 备注: 
   */
   public void setZyzhdm(String zyzhdm){
        this.zyzhdm = zyzhdm;
   }
   /**
   * 字段名：zyzhmc
   ...
   * 备注: 
   */
   public void setZyzhmc(String zyzhmc){
        this.zyzhmc = zyzhmc;
   }
   /**
   * 字段名：bzyj
   ...
   * 备注: 
   */
   public void setYzxmlx(String yzxmlx){
        this.yzxmlx = yzxmlx;
   }
   /**
   * 字段名：yzxmlxmc
   ...
   * 备注: 
   */
   public void setYzklzdm(String yzklzdm){
        this.yzklzdm = yzklzdm;
   }
   /**
   * 字段名：yzklzqm
   * get方法
   ...
   * 备注: 
   */
   public java.sql.Timestamp getYzklrq(){
   ...
   * 备注: 
   */
   public void setYzklrq(java.sql.Timestamp yzklrq){
        this.yzklrq = yzklrq;
   }
   /**
   * 字段名：yzshzdm
   ...
   * 备注: 
   */
   public void setYzshzdm(String yzshzdm){
        this.yzshzdm = yzshzdm;
   }
   /**
   * 字段名：yzshzqm
   * get方法
   ...
   * 备注: 
   */
   public java.sql.Timestamp getYzshrq(){
   ...
   * 备注: 
   */
   public void setYzshrq(java.sql.Timestamp yzshrq){
        this.yzshrq = yzshrq;
   }
   /**
   * 字段名：yzzxksdm
   ...
   * 备注: 
   */
   public void setYzzxzdm(String yzzxzdm){
        this.yzzxzdm = yzzxzdm;
   }
   /**
   * 字段名：yzzxzqm
   * get方法
   ...
   * 备注: 
   */
   public java.sql.Timestamp getYzzxrq(){
   ...
   * 备注: 
   */
   public void setYzzxrq(java.sql.Timestamp yzzxrq){
        this.yzzxrq = yzzxrq;
   }
   /**
   * 字段名：yzzxzt
   ...
   * 备注: 
   */
   public void setQxyzzdm(String qxyzzdm){
        this.qxyzzdm = qxyzzdm;
   }
   /**
   * 字段名：qxyzzqm
   * get方法
   ...
   * 备注: 
   */
   public java.sql.Timestamp getYzqxrq(){
   ...
   * 备注: 
   */
   public void setYzqxrq(java.sql.Timestamp yzqxrq){
        this.yzqxrq = yzqxrq;
   }
   /**
   * 字段名：zrysbm
   ...
   * 备注: 
   */
   public java.sql.Timestamp getYzjhjsrq(){
   ...
   * 备注: 
   */
   public void setYzjhjsrq(java.sql.Timestamp yzjhjsrq){
        this.yzjhjsrq = yzjhjsrq;
   }
   /**
   * 字段名：dzsqdbh
   * get方法
   ...
   * 备注: 
   */
   public void setJzlgbcjl(String jzlgbcjl){
        this.jzlgbcjl = jzlgbcjl;
   }
   /**
   * 字段名：qjksrq
   * get方法
   * 备注: 
   */
   public java.sql.Timestamp getQjksrq(){
   ...
   * 备注: 
   */
   public void setQjksrq(java.sql.Timestamp qjksrq){
        this.qjksrq = qjksrq;
   }
   /**
   * 字段名：qjjsrq
   ...
   * 备注: 
   */
   public java.sql.Timestamp getQjjsrq(){
   ...
   * 备注: 
   */
   public void setQjjsrq(java.sql.Timestamp qjjsrq){
        this.qjjsrq = qjjsrq;
   }
   /**
   * 字段名：jzqjjl
   ...
   * 备注: 
   */
   public void setJzqjjl(String jzqjjl){
        this.jzqjjl = jzqjjl;
   }
   /**
   * 字段名：ssjczbm
   ...
   * 备注: 
   */
   public void setSsmbbwbm(String ssmbbwbm){
        this.ssmbbwbm = ssmbbwbm;
   }
   /**
   * 字段名：ssmbbw
   * get方法
   ...
   * 备注: 
   */
   public void setSsmbbw(String ssmbbw){
        this.ssmbbw = ssmbbw;
   }
   /**
   * 字段名：jrwdm
   ...
   * 备注: 
   */
   public void setJrwdm(String jrwdm){
        this.jrwdm = jrwdm;
   }
   /**
   * 字段名：jrwmc
   ...
   * 备注: 
   */
   public void setSsjczff(String ssjczff){
        this.ssjczff = ssjczff;
   }
   /**
   * 字段名：ssjczcs
   * get方法
   ...
   * 备注: 
   */
   public void setSsjczcs(String ssjczcs){
        this.ssjczcs = ssjczcs;
   }
   /**
   * 字段名：jlrqsj
   * get方法
   * 备注: 
   */
   public java.sql.Timestamp getJlrqsj(){
   ...
   * 备注: 
   */
   public void setJlrqsj(java.sql.Timestamp jlrqsj){
        this.jlrqsj = jlrqsj;
   }
   /**
   * 字段名：zysx
   ...
   * 备注: 
   */
   public void setCjqjrydm(String cjqjrydm){
        this.cjqjrydm = cjqjrydm;
   }
   /**
   * 字段名：cjqjrymd
   * get方法
   ...
   * 备注: 
   */
   public void setCjqjrymd(String cjqjrymd){
        this.cjqjrymd = cjqjrymd;
   }
   /**
   * 字段名：zyjszwlb
   * get方法
   ...
   * 备注: 
   */
   public void setZyjszwlbmc(String zyjszwlbmc){
        this.zyjszwlbmc = zyjszwlbmc;
   }
   /**
   * 字段名：hzqxdm
   * get方法
   ...
   * 备注: 
   */
   public void setHzqxmc(String hzqxmc){
        this.hzqxmc = hzqxmc;
   }
   /**
   * 字段名：ysbm
