 ...
 */
@Alias("hlhtZybcjlSjyscfjl")
public class HlhtZybcjlSjyscfjl extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setCfjl(String cfjl){
        this.cfjl = cfjl;
   }
   /**
   * 字段名：yznr
   ...
   * 备注: 
   */
   public void setYljh(String yljh){
        this.yljh = yljh;
   }
   /**
   * 字段名：jlrbm
