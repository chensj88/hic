 ...
 */
@Alias("hlhtBlgyWssjzy")
public class HlhtBlgyWssjzy extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private String qtxyzd;
    /**
     * 字段名：qtxyzdmc
     * 备注: 
     * 默认值：无
     */
    private String qtxyzdmc;
    /**
     * 字段名：ssjcz
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public void setJmjkkh(String jmjkkh){
        this.jmjkkh = jmjkkh;
   }
   /**
   * 字段名：zzjgdm
   ...
   * 备注: 
   */
   public void setHzlxdm(String hzlxdm){
        this.hzlxdm = hzlxdm;
   }
   /**
   * 字段名：hzlxmc
   ...
   * 备注: 
   */
   public void setHzlxmc(String hzlxmc){
        this.hzlxmc = hzlxmc;
   }
   /**
   * 字段名：jzrqsj
   ...
   * 备注: 
   */
   public void setRyrqsj(Date ryrqsj){
        this.ryrqsj = ryrqsj;
   }
   /**
   * 字段名：cyrqsj
   ...
   * 备注: 
   */
   public void setFbrqsj(Date fbrqsj){
        this.fbrqsj = fbrqsj;
   }
   /**
   * 字段名：jzyy
   ...
   * 备注: 
   */
   public void setXyzd(String xyzd){
        this.xyzd = xyzd;
   }
   /**
   * 字段名：xyzdmc
   ...
   * 备注: 
   */
   public void setQtxyzd(String qtxyzd){
        this.qtxyzd = qtxyzd;
   }
   /**
   * 字段名：qtxyzdmc
   ...
   * 备注: 
   */
   public void setQtxyzdmc(String qtxyzdmc){
        this.qtxyzdmc = qtxyzdmc;
   }
   /**
   * 字段名：ssjcz
   * get方法
   ...
   * 备注: 
   */
   public void setGjywdm(String gjywdm){
        this.gjywdm = gjywdm;
   }
   /**
   * 字段名：gjywmc
   ...
   * 备注: 
   */
   public void setGjywyf(String gjywyf){
        this.gjywyf = gjywyf;
   }
   /**
   * 字段名：ywblfy
   ...
   * 备注: 
   */
   public void setGbsy(String gbsy){
        this.gbsy = gbsy;
   }
   /**
   * 字段名：gbsymc
   ...
   * 备注: 
   */
   public void setGbsymc(String gbsymc){
        this.gbsymc = gbsymc;
   }
   /**
   * 字段名：zljg
