 ...
 */
@Alias("hlhtZybcjlSwjl")
public class HlhtZybcjlSwjl extends BaseDomain implements Serializable {
     ...
     * 备注:
     */
    public void setJstysjbz(String jstysjbz) {
        this.jstysjbz = jstysjbz;
    }
