 ...
 */
@Alias("hlhtZlczjlYbssjl")
public class HlhtZlczjlYbssjl extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private String sqzdbm;
    /**
     * 字段名：sqzdmc
     * 备注: 
     * 默认值：无
     */
    private String sqzdmc;
    /**
     * 字段名：shzdbm
     * 备注: 
     * 默认值：无
     */
    private String shzdbm;
    /**
     * 字段名：shzdmc
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String sszbm;
    /**
     * 字段名：sszxm
     * 备注: 
     * 默认值：无
     */
    private String sszxm;
    /**
     * 字段名：yzbm
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public void setDzsqsbh(String dzsqsbh){
        this.dzsqsbh = dzsqsbh;
   }
   /**
   * 字段名：ksdm
   * get方法
   ...
   * 备注: 
   */
   public void setSsksrq(Date ssksrq){
        this.ssksrq = ssksrq;
   }
   /**
   * 字段名：ssjsrq
   ...
   * 备注: 
   */
   public void setSsjsrq(Date ssjsrq){
        this.ssjsrq = ssjsrq;
   }
   /**
   * 字段名：ssjczbm
   ...
   * 备注: 
   */
   public void setSsjbdm(String ssjbdm){
        this.ssjbdm = ssjbdm;
   }
   /**
   * 字段名：ssjbmc
   ...
   * 备注: 
   */
   public void setSsmbbwdm(String ssmbbwdm){
        this.ssmbbwdm = ssmbbwdm;
   }
   /**
   * 字段名：ssmbbw
   * get方法
   ...
   * 备注: 
   */
   public void setSssbz(String sssbz){
        this.sssbz = sssbz;
   }
   /**
   * 字段名：pfxd
   ...
   * 备注: 
   */
   public void setPfxd(String pfxd){
        this.pfxd = pfxd;
   }
   /**
   * 字段名：ssqk
   ...
   * 备注: 
   */
   public void setCxl(Integer cxl){
        this.cxl = cxl;
   }
   /**
   * 字段名：syl
   ...
   * 备注: 
   */
   public void setSyl(Integer syl){
        this.syl = syl;
   }
   /**
   * 字段名：sxl
   ...
   * 备注: 
   */
   public void setSqyydm(String sqyydm){
        this.sqyydm = sqyydm;
   }
   /**
   * 字段名：sqyy
   ...
   * 备注: 
   */
   public void setSzyydm(String szyydm){
        this.szyydm = szyydm;
   }
   /**
   * 字段名：szyy
   ...
   * 备注: 
   */
   public void setYlcldm(String ylcldm){
        this.ylcldm = ylcldm;
   }
   /**
   * 字段名：ylclmc
   ...
   * 备注: 
   */
   public void setYlclmc(String ylclmc){
        this.ylclmc = ylclmc;
   }
   /**
   * 字段名：ylclsm
   ...
   * 备注: 
   */
   public void setYlclsm(String ylclsm){
        this.ylclsm = ylclsm;
   }
   /**
   * 字段名：fzbwdm
   ...
   * 备注: 
   */
   public void setFzbwdm(String fzbwdm){
        this.fzbwdm = fzbwdm;
   }
   /**
   * 字段名：fzbw
   ...
   * 备注: 
   */
   public void setFzbw(String fzbw){
        this.fzbw = fzbw;
   }
   /**
   * 字段名：sxfybz
   ...
   * 备注: 
   */
   public void setSxfybz(String sxfybz){
        this.sxfybz = sxfybz;
   }
   /**
   * 字段名：sszbm
   ...
   * 备注: 
   */
   public void setSszbm(String sszbm){
        this.sszbm = sszbm;
   }
   /**
   * 字段名：sszxm
   ...
   * 备注: 
   */
   public void setSszxm(String sszxm){
        this.sszxm = sszxm;
   }
   /**
   * 字段名：yzbm
   ...
   * 备注: 
   */
   public void setEzbm(String ezbm){
        this.ezbm = ezbm;
   }
   /**
   * 字段名：ezxm
   ...
   * 备注: 
   */
   public void setEzxm(String ezxm){
        this.ezxm = ezxm;
   }
   /**
   * 字段名：qxhsbm
   ...
   * 备注: 
   */
   public void setQxhsbm(String qxhsbm){
        this.qxhsbm = qxhsbm;
   }
   /**
   * 字段名：qxhsxm
   ...
   * 备注: 
   */
   public void setQxhsxm(String qxhsxm){
        this.qxhsxm = qxhsxm;
   }
   /**
   * 字段名：xthsbm
   ...
   * 备注: 
   */
   public void setXthsbm(String xthsbm){
        this.xthsbm = xthsbm;
   }
   /**
   * 字段名：xthsxm
   ...
   * 备注: 
   */
   public void setXthsxm(String xthsxm){
        this.xthsxm = xthsxm;
   }
   /**
   * 字段名：mzff
   ...
   * 备注: 
   */
   public void setMzysbm(String mzysbm){
        this.mzysbm = mzysbm;
   }
   /**
   * 字段名：mzysxm
   ...
   * 备注: 
   */
   public void setSsysbm(String ssysbm){
        this.ssysbm = ssysbm;
   }
   /**
   * 字段名：sszqm
