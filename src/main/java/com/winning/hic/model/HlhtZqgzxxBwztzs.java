 ...
 */
@Alias("hlhtZqgzxxBwztzs")
public class HlhtZqgzxxBwztzs extends BaseDomain implements Serializable {
   ...
   * 备注: 
   */
   public void setBqgkjqjcs(String bqgkjqjcs){
        this.bqgkjqjcs = bqgkjqjcs;
   }
   /**
   * 字段名：tznr
   * get方法
