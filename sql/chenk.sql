...
UPDATE CISDB_DATA..HLHT_ZYBCJL_SCBCJL SET zyszgcjg=NULL WHERE CONVERT(varchar,zyszgcjg) ='N'
...
UPDATE CISDB_DATA..HLHT_ZYBCJL_SCBCJL SET zfbm=NULL WHERE zfbm='N'
UPDATE CISDB_DATA..HLHT_ZYBCJL_SCBCJL SET zzzf=NULL WHERE zzzf='N'
