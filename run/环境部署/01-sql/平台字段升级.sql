...
alter table	HLHT_ZYBCJL_SQXJ	alter column	sqzdbm		varchar(500)	 not null 	;
alter table	HLHT_ZYBCJL_SQXJ	alter column	sqzdmc		varchar(1000)	 not null 	;
...
alter table	HLHT_ZYBCJL_SQXJ	alter column	gms		text	 not null 	;
...
alter table	HLHT_ZYBCJL_SWBLTLJL	alter column	zyzwlbdm		varchar(36)	 not null 	;
...
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czxyzdbm		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czxyzd		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czzybmdm		varchar(128)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czzybm		varchar(256)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czzyzhdm		varchar(128)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	czzyzh		varchar(256)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzxyzdbm		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzxyzdmc		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzzybmdm		varchar(256)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzzybmmc		varchar(256)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzzyzhbm		varchar(128)		;
alter table	HLHT_ZYBCJL_SCBCJL	alter column	jzzyzhmc		varchar(256)		;
...
alter table	HLHT_ZYBCJL_HZJL	alter column	hzmd		nvarchar(200)	 not null 	;
...
alter table	HLHT_CYXJ_CYXJ	alter column	rzxyzdbm		varchar(512)	 not null 	;
alter table	HLHT_CYXJ_CYXJ	alter column	rzxyzd		varchar(512)	 not null 	;
alter table	HLHT_CYXJ_CYXJ	alter column	rzzybmdm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	rzzybm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	rzzyzhdm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	rzzyzh		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	czxyzdbm		varchar(512)	 not null 	;
alter table	HLHT_CYXJ_CYXJ	alter column	czxyzd		varchar(512)	 not null 	;
alter table	HLHT_CYXJ_CYXJ	alter column	czzybmdm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	czzybm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	czzyzhdm		varchar(512)		;
alter table	HLHT_CYXJ_CYXJ	alter column	czzyzh		varchar(512)		;
...
alter table	HLHT_CYXJ_CYXJ	alter column	ssczbm		varchar(512)	 not null 	;
alter table	HLHT_CYXJ_CYXJ	alter column	ssjczmc		varchar(512)	 not null 	;
...
alter table	HLHT_CYXJ_CYXJ	alter column	zljgdm		varchar(10)	 not null 	;
...
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzxyzdbm		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzxyzd		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzzybmdm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzzybm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzzyzhdm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	rzzyzh		varchar(256)		;
...
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdxyzdbm		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdxyzd		varchar(256)	 not null 	;
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdzybmdm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdzybm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdzyzhdm		varchar(256)		;
alter table	HLHT_ZYBCJL_ZKJL	alter column	mqzdzyzh		varchar(256)		;
...
alter table	HLHT_MJZBL_MJZBL	alter column	xyzdbm		varchar(512)	 not null 	;
alter table	HLHT_MJZBL_MJZBL	alter column	xyzdmc		varchar(512)	 not null 	;
alter table	HLHT_MJZBL_MJZBL	alter column	zybmdm		varchar(512)		;
alter table	HLHT_MJZBL_MJZBL	alter column	zybmmc		varchar(512)		;
alter table	HLHT_MJZBL_MJZBL	alter column	zyzhdm		varchar(512)		;
alter table	HLHT_MJZBL_MJZBL	alter column	zyzhmc		varchar(512)		;
...
alter table	HLHT_BLGY_WSSJZY	alter column	xyzd		varchar(512)	 not null 	;
alter table	HLHT_BLGY_WSSJZY	alter column	xyzdmc		varchar(512)	 not null 	;
alter table	HLHT_BLGY_WSSJZY	alter column	zybm		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	zybmmc		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	zyzh		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	zyzhmc		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	qtxyzd		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	qtxyzdmc		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	ssjcz		varchar(512)		;
alter table	HLHT_BLGY_WSSJZY	alter column	ssjczmc		varchar(512)		;
...
alter table HLHT_ZLCZJL_YBSSJL alter column mzff varchar(10) not null;
